...
public class PatientServiceImpl implements PatientService {
    ...
    public ApiResponse addPatient(PatientRequestDTO dto) {
        ...
        // ✅ Create USER manually (correct approach)
        User user = new User();
    ...
    // =========================
    @Override
    public ApiResponse editPatientProfile(Long patientId,
                                          EditPatientRequest request) {
    ...
    public ApiResponse bookAppointment(AppointmentRequestDTO dto) {
        ...
        if (patient.getUser().getRole() != UserRole.ROLE_PATIENT) {
